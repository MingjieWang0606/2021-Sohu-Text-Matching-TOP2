...
if __name__ == '__main__':
    # x_input = torch.randn(5,2)            #随机生成输入 
    # print('x_input:\n',x_input) 
    # y_target = torch.tensor([1,1,0,1,0])      #设置输出具体值 print('y_target\n',y_target)

    # crossentropyloss = nn.CrossEntropyLoss()
    # crossentropyloss_output = crossentropyloss(x_input,y_target)
    # print('crossentropyloss_output:\n', crossentropyloss_output)

    # focalloss = focal_loss(num_classes=2)
    # focalloss_output = focalloss(x_input, y_target)
    # print('focalloss_output:\n', focalloss_output)
